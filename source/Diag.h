...
/**
    ...
    **A frame ring that could not be allocated.** This plugin holds up to
    sixteen full pictures in one array texture, and the failure mode when the
    ...
    almost always Readout Time or Exposure -- the ring is sized from the two.
*/
namespace readout::diag
{
