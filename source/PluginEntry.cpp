/**
	...
	`CFFGLPluginInfo` that Readout.cpp registers at static-initialisation
	...
	binary: which build it is.
		...
		strings Readout.bundle/Contents/MacOS/Readout | grep readout
*/

extern "C" const char* ReadoutBuildStamp()
{
	return "readout " READOUT_VERSION " built " __DATE__ " " __TIME__;
}
