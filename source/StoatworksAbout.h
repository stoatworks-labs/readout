/*
 * Stoatworks Labs - About window data for Readout.
 *
 * PROVISIONAL, hand-written in the shape stoatworks-backend/scripts/sync-about.py
 * generates. Readout is not yet registered in the website's projects.json, so
 * the sync cannot produce this file; once it is, `sync-about.py --only
 * readout --apply` overwrites this with the generated copy. The facts below
...
{
    inline constexpr auto name = "Readout";
    inline constexpr auto slug = "readout";
    inline constexpr auto hook = "A CMOS rolling shutter for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "";
    inline constexpr auto page = "https://stoatworks-labs.com/software/readout/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/readout";
